...
<div class="max-w-2xl mx-auto bg-white p-8 rounded shadow-md">
    ...
    <form action="{{ route('admin.vehicles.update', $vehicle) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="vehicle_type" value="{{ $vehicle->vehicle_type }}" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300" required>
        </div>
        <div class="mb-4">
            <label class="block text-gray-700">Capacity</label>
            <input type="number" name="capacity" value="{{ $vehicle->capacity }}" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300" required>
        </div>
        <div class="mb-4">
        ...
        <div class="flex justify-between">
            ...
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition duration-200">Update Vehicle</button>
        </div>
    </form>
</div>
@endsection
